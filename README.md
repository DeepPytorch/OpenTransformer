...
<p>Because of the block layers</p>
<p>This model would have to be trained on a massive GPU cluster nubering over 5000, however that is nothing compared to the 50's of thousands of high-end gpus required to train a different model of the same size.</p>
